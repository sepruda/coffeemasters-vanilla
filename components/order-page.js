export class OrderPage extends HTMLElement {
  ...
  setFormBindings(form) {
    ...
    // set double data binding, using DOM form API
    this.#user = new Proxy(this.#user, {
      set(target, property, value) {
        target[property] = value;
        form.elements[property].value = value;

        // If you don't return true, the set will be falshish
        return true;
      },
    });

    // Using Array.from since the collection is an HTMLelement list, that doesn't have ES6 methods
